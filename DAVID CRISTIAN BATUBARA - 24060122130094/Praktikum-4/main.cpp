...
/*
	NAMA : DAVID CRISTIAN BATUBARA & 24060122130094
...
void keyboard(unsigned char key, int x, int y){        
	switch (key) {
	case 'o': shoulder = (shoulder + 5) % 360;         
	glutPostRedisplay();
	break;  case 'O': shoulder = (shoulder -5) % 360;  
	glutPostRedisplay();
	break;  case 'i': elbow = (elbow + 5) % 360;       
	glutPostRedisplay();
	break;  case 'I': elbow = (elbow -5) % 360;        
	glutPostRedisplay();
	break;  case 'p': palm = (palm + 5) % 360;       
	glutPostRedisplay();
	break;  case 'P': palm = (palm -5) % 360;        
	glutPostRedisplay();
	break;  case 'q': jempol = (jempol + 5) % 360;       
	glutPostRedisplay();
	break;  case 'Q': jempol = (jempol -5) % 360;        
	glutPostRedisplay();
	break;  case 'w': telunjuk = (telunjuk + 5) % 360;       
	glutPostRedisplay();
	break;  case 'W': telunjuk = (telunjuk -5) % 360;        
	glutPostRedisplay();
	break;  case 'e': tengah = (tengah + 5) % 360;       
	glutPostRedisplay();
	break;  case 'E': tengah = (tengah -5) % 360;        
	glutPostRedisplay();
	break;  case 'a': manis = (manis + 5) % 360;       
	glutPostRedisplay();
	break;  case 'A': manis = (manis -5) % 360;        
	glutPostRedisplay();
	break;  case 'd': kelingking = (kelingking + 5) % 360;       
	glutPostRedisplay();
	break;  case 'D': kelingking = (kelingking -5) % 360;        
	glutPostRedisplay();
